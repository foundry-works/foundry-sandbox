...
cmd_help() {
    ...
    echo "                            [--with-ssh] [--no-isolate-credentials] Create sandbox from repo"
    ...
    echo "  $0 new user/repo feat --network=limited        # whitelist network access"
    echo "  $0 new user/repo feat --no-isolate-credentials  # pass API keys directly"
