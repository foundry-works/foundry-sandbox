...
# TestDefenseInDepth removed: its tests for merge, auto-merge, and review
# deletion are fully covered by the parametrized test_both_layers_block in
# TestDualLayerConsistency, which iterates over all BLOCKED_OPERATIONS and
# verifies both layers block each operation.
